...
public class PricingCategory {
    ...
    public void setPricingCategoryCode(final String pricingCategoryCode) {
    ...
    public void setPricingCategoryName(final String pricingCategoryName) {
    ...
    public void setTicketPrices(final List<TicketPrice> ticketPrices) {
