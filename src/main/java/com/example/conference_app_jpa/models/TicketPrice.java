...
@NamedQuery(name = "TicketPrice.namedFindTicketsByPricingCategoryName", query = "select tp from TicketPrice tp where tp.pricingCategory.pricingCategoryName = :name")
@NamedNativeQuery(name = "TicketPrice.nativeFindTicketsByCategoryWithWorkshop", query = "select tp.* from ticket_prices tp "
        ...
        + "where tt.includes_workshop = true and pc.pricing_category_name = :name", resultClass = TicketPrice.class)
